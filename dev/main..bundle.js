...
eval("__webpack_require__.a(module, async (__webpack_handle_async_dependencies__, __webpack_async_result__) => { try {\n__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   drawTitleContent: () => (/* binding */ drawTitleContent)\n/* harmony export */ });\n/* harmony import */ var _ip_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./ip.js */ \"./src/ip.js\");\n/* harmony import */ var _weather_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./weather.js */ \"./src/weather.js\");\n/* harmony import */ var _city_list_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./city-list.js */ \"./src/city-list.js\");\n/* harmony import */ var _localStorage_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./localStorage.js */ \"./src/localStorage.js\");\n/* harmony import */ var _map_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./map.js */ \"./src/map.js\");\n/* harmony import */ var _style_style_css__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./style/style.css */ \"./src/style/style.css\");\nvar __webpack_async_dependencies__ = __webpack_handle_async_dependencies__([_city_list_js__WEBPACK_IMPORTED_MODULE_2__]);\n_city_list_js__WEBPACK_IMPORTED_MODULE_2__ = (__webpack_async_dependencies__.then ? (await __webpack_async_dependencies__)() : __webpack_async_dependencies__)[0];\n\r\n\r\n\r\n\r\n\r\n\r\n\r\n\r\nconsole.log(\"Я подключен\");\r\n\r\n// Ищем элементы по странице\r\nconst city = document.querySelector('.city');\r\nconst temp = document.querySelector('.temperature');\r\nconst img = document.querySelector('img');\r\n\r\n// Отрисовываем данные пользователя\r\nlet myCity = await (0,_ip_js__WEBPACK_IMPORTED_MODULE_0__.getUserIp)();\r\ndrawTitleContent(myCity);\r\n(0,_map_js__WEBPACK_IMPORTED_MODULE_4__.initMap)(myCity);\r\n\r\nasync function drawTitleContent(currentCity){\r\n    try{\r\n        currentCity = (typeof(currentCity) == 'object') ? currentCity.city : currentCity;\r\n        city.textContent = currentCity;\r\n        const tempAndIcon = await (0,_weather_js__WEBPACK_IMPORTED_MODULE_1__.getWeatherAndIcon)(currentCity);\r\n        temp.textContent = `${tempAndIcon[0]}°C `;\r\n        img.src = `http://openweathermap.org/img/wn/${tempAndIcon[1]}@2x.png`; \r\n    }catch(e){\r\n        return\r\n    }\r\n}\r\n  \r\n// Список городов\r\nconst listCity = document.querySelector('.content__list')\r\nconst getCity = await (0,_localStorage_js__WEBPACK_IMPORTED_MODULE_3__.readList)();\r\n(0,_city_list_js__WEBPACK_IMPORTED_MODULE_2__.drawCityList)(listCity,getCity)\r\n\r\n\r\n// Запрос пользователя \r\nconst input = document.querySelector('.input')\r\nconst btn = document.querySelector('.btn');\r\n \r\nbtn.addEventListener('click', async () => {\r\n    let value = input.value.trim();\r\n    if (value === \"\") {\r\n        alert(\"Проверьте, что Вы ввели город\")\r\n    } else {\r\n        drawTitleContent(value);\r\n        input.value = \"\";\r\n        getCity.push(value);\r\n        (0,_city_list_js__WEBPACK_IMPORTED_MODULE_2__.drawCityList)(listCity, getCity);\r\n        (0,_localStorage_js__WEBPACK_IMPORTED_MODULE_3__.saveList)(getCity);\r\n        (0,_map_js__WEBPACK_IMPORTED_MODULE_4__.initMap)(value);\r\n    }  \r\n    \r\n})\r\n\r\n\r\n\n__webpack_async_result__();\n} catch(e) { __webpack_async_result__(e); } }, 1);\n\n//# sourceURL=webpack://weatherapp/./src/index.js?");
...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   getUserIp: () => (/* binding */ getUserIp)\n/* harmony export */ });\nasync function getUserIp(){\r\n    try {\r\n        const response = await fetch(`https://get.geojs.io/v1/ip/geo.json`);\r\n        const data = await response.json();\r\n        return data;\r\n    }catch(error){\r\n        alert('Данные не пришли,попробуйте еще раз');\r\n    }\r\n}\n\n//# sourceURL=webpack://weatherapp/./src/ip.js?");
...
eval("module.exports = __webpack_require__.p + \"images\\\\main.9bec26efce82214386a7.jpg\";\n\n//# sourceURL=webpack://weatherapp/./src/img/main.jpg?");
